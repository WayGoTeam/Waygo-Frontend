    ...
    <div className="relative h-full overflow-y-auto scroll-thin bg-slate-50 dark:bg-slate-900/50">
      ...
      <div className="mx-auto max-w-[1200px] space-y-8 p-5 sm:p-7 pb-16">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="font-display text-3xl font-bold text-slate-900 dark:text-slate-50">{s.weather.pageTitle}</h1>
        ...
        <div className="rounded-[32px] border border-slate-200 dark:border-slate-800/50 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm shadow-xl shadow-slate-200/20 overflow-hidden min-h-[400px]">
          {weather.loading && !weather.data ? (
            ...
            <div className="grid grid-cols-1 divide-y divide-slate-100 dark:divide-slate-800 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4 lg:divide-x">
              {weather.data
