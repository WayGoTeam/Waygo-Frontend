    ...
    <div className="fixed bottom-[5.5rem] right-3 z-[1000] flex h-[min(30rem,60vh)] w-[min(23rem,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-float animate-fade-up sm:bottom-24 sm:right-6 sm:h-[min(30rem,70vh)]">
      ...
      >
        <input
          ...
          className="min-w-0 flex-1 rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 px-3.5 py-2 text-sm text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:border-brand-300 dark:focus:border-brand-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900/40"
        />
        <button
          type="button"
