...
export function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-white dark:border-slate-700/50 bg-white/70 dark:bg-slate-900/70 p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <span className="text-sm font-semibold tracking-wide text-slate-500 dark:text-slate-400">{label}</span>
      </div>
